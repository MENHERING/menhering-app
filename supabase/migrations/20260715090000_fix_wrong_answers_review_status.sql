-- wrong_answers.review_status는 chk_review_status 제약조건상 'unreviewed'/'reviewed'만 허용하는데,
-- submit_quiz_result가 한글 '미복습'을 넣으려다 매 제출마다 제약조건 위반(23514)으로 실패하고 있었다.
-- 오답노트(#19) 쪽 실제 허용값에 맞춰 영문 리터럴로 교체한다.
